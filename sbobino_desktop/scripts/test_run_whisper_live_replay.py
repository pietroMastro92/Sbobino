...
class FinalizedTranscriptTests(unittest.TestCase):
    ...
    def test_live_command_profile_matches_cpu_and_auto_runtime_windows(self):
        self.assertEqual(live_command_profile("cpu", 4), (4, 1280, 2000, 1024))
        self.assertEqual(live_command_profile("auto", 12), (8, 1000, 2000, 1024))
        self.assertEqual(live_command_profile("cpu", None), (1, 1280, 2000, 1024))
